...
- **Catalogo Ciao Darwin**: la lista dei suoni del programma da procurarsi (sigla "Matti", Adiemus/Madre Natura, Genodrome, cilindroni, Laurenti…), con link di ricerca e un pulsante per assegnarli all'evento automatico adatto. I clip originali sono protetti da copyright e **non** sono inclusi nel repo: vanno scaricati e caricati dalla console.
